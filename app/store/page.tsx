  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <NetworkNav 
        ...
        siteColor="bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400 text-transparent bg-clip-text"
      />
      ...
      <footer className="border-t border-gray-800 py-8 mt-16">
        <div className="max-w-7xl mx-auto px-4 text-center text-gray-400">
          <p className="text-sm">Git is Public • Transparency • Open Source • Auditable</p>
